...
def _cors_allowed_origins() -> list[str]:
    ...
    api_hostname = urlparse(_coerce_non_empty_origin(settings.api_url) or "").hostname
    if api_hostname == "api-codey.autohustle.online":
        origins.add("https://codey.autohustle.online")
