...
class Project(Base):
    ...
    file_tree: Mapped[dict[str, Any] | None] = mapped_column(JSONB)
    latest_nfet_phase: Mapped[str | None] = mapped_column(String(20))
    latest_es_score: Mapped[float | None] = mapped_column(Float)
